...
<!-- FORK NOTE (ViZAlice/codegraph only, not upstream): fork maintenance rules — branch model, upstream sync, npm release (`npm-v*` tags, `@vizalice` scope) — live in the repo-root AGENTS.md. Read it before doing any git push, tag, or release work in this repo. -->
