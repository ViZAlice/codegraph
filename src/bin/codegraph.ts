...
async function loadCodeGraph(): Promise<typeof import('../index')> {
  try {
    ...
    console.error(`\n  Error: ${msg}`);
    console.error('\n  Try reinstalling with: npm install -g @vizalice/codegraph\n');
    process.exit(1);
  }
}
...
program
  .command('install')
  .description('Install codegraph MCP server into one or more agents (Claude Code, Cursor, Codex CLI, opencode, Hermes Agent, Gemini CLI, Antigravity IDE, Kiro, GitHub Copilot, ZCode, DeepSeek Harness (dsh))')
